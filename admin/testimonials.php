						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT CUSTOMERS.FullName,TESTIMONIAL.UserEmail,TESTIMONIAL.Testimonial,TESTIMONIAL.PostingDate,TESTIMONIAL.status,TESTIMONIAL.id from TESTIMONIAL join CUSTOMERS on CUSTOMERS.Emailid=TESTIMONIAL.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
