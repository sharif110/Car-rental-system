...
<?php $sql = "SELECT VEHICLES.VehiclesTitle,CARBRANDS.BrandName,VEHICLES.PricePerDay,VEHICLES.FuelType,VEHICLES.ModelYear,VEHICLES.id from VEHICLES join CARBRANDS on CARBRANDS.id=VEHICLES.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
