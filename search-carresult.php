...
$sql = "SELECT VEHICLES.*,CARBRANDS.BrandName,CARBRANDS.id as bid  from VEHICLES join CARBRANDS on CARBRANDS.id=VEHICLES.VehiclesBrand where VEHICLES.VehiclesBrand=:brand and VEHICLES.FuelType=:fueltype";
$query = $dbh -> prepare($sql);
$query -> bindParam(':brand',$brand, PDO::PARAM_STR);
$query -> bindParam(':fueltype',$fueltype, PDO::PARAM_STR);
$query->execute();
...
<option value="CNG">CNG</option>
        ...
        <div class="sidebar_widget">
          ...
          <div class="recent_addedcars">
            <ul>
<?php $sql = "SELECT VEHICLES.*,CARBRANDS.BrandName,CARBRANDS.id as bid  from VEHICLES join CARBRANDS on CARBRANDS.id=VEHICLES.VehiclesBrand order by id desc limit 4";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
