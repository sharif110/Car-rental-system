...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  RESERVATION(userEmail,VehicleId,FromDate,ToDate,message,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:message,:status)";
...
<title>SHARIF Car Rental Port | Vehicle Details</title>
<!--Bootstrap -->
...
$sql = "SELECT VEHICLES.*,CARBRANDS.BrandName,CARBRANDS.id as bid  from VEHICLES join CARBRANDS on CARBRANDS.id=VEHICLES.VehiclesBrand where VEHICLES.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
...
<?php 
$bid=$_SESSION['brndid'];
$sql="SELECT VEHICLES.VehiclesTitle,CARBRANDS.BrandName,VEHICLES.PricePerDay,VEHICLES.FuelType,VEHICLES.ModelYear,VEHICLES.id,VEHICLES.SeatingCapacity,VEHICLES.VehiclesOverview,VEHICLES.Vimage1 from VEHICLES join CARBRANDS on CARBRANDS.id=VEHICLES.VehiclesBrand where VEHICLES.VehiclesBrand=:bid";
$query = $dbh -> prepare($sql);
