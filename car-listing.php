...
<title>SHARIF CAR RENTAL SERVICES | Car Listing</title>
<!--Bootstrap -->
...
<?php $sql = "SELECT VEHICLES.*,CARBRANDS.BrandName,CARBRANDS.id as bid  from VEHICLES join CARBRANDS on CARBRANDS.id=VEHICLES.VehiclesBrand";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
